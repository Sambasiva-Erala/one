...
<body>
	...
	<h1 style="color: black; font-size: 40px;" align="center">We have deployed the application</h1>
        <h1 style="color: black; font-size: 40px;" align="center">Today we don't have class</h1>
